...
void Check(int a[], int n)
{
    ...
    if (pr == 0) printf("was sorted!\n");
    else printf("Was mistake...\n");
}
...
int main()
{
    ...
    printf("я программа, которая сортирует массивы!\n");
    printf("вот мои команды:\n");
    commands();
    ...
    while (run)
    {
        ...
        case 1: {
            ...
            do {
                ...
                scanf_s("%d", &n);
                if (n < 1) printf("Данные некорректны, введите натуральное n\n");
            } while (n < 1);
        ...
        case 3: {   if (flag == 1)
        {
            ...
            printf("сначала введите массив в команде 1\n");
            printf("введи новую команду)\n");
            break; }
        case 4: {   if (flag == 1)
        {
        ...
        case 8: {   if (flag == 1)
        {
            ...
            break; }
        case 9: {
            printf("уже уходите? хорошего дня!!\n");
            run = 0;
            break; }
